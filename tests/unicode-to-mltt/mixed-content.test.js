...
console.log('--- TEST: Unicode -> ML-TT Mixed Content & Words ---');
let passed = 0;
let failed = 0;

for (const [unicode, expected] of Object.entries({ ...fixtures.words, ...fixtures.mixed })) {
...
console.log(`Mixed Content Test: ${passed} passed, ${failed} failed.`);
