...
console.log('--- TEST: ML-TT -> Unicode Conjuncts ---');
let passed = 0;
let failed = 0;

for (const [ascii, expected] of Object.entries(fixtures.conjuncts)) {
...
console.log(`ML-TT Conjuncts Test: ${passed} passed, ${failed} failed.`);
