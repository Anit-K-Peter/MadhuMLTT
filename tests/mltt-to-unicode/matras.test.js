...
console.log('--- TEST: ML-TT -> Unicode Matras ---');
let passed = 0;
let failed = 0;

for (const [ascii, expected] of Object.entries(fixtures.matras)) {
...
console.log(`ML-TT Matras Test: ${passed} passed, ${failed} failed.`);
